...
public struct HTTPStatus {
    ...
    public var code:HTTPStatusCodes
    public var summary:String
}

public class HTTPUtilsDecodeStatusCode {
    public static func status (code:HTTPStatusCodes)->HTTPStatus {
        return HTTPStatus(description: statusDescription(code), code: code, summary: String(code))
    }
    
    private static func statusDescription (code:HTTPStatusCodes)->String {
        switch code {
        case .Continue: // 100
